...
class NewsManagerMySQLi extends NewsManager
{
    ...
    {
        $requete = $this->db->prepare('INSERT INTO new(auteur, titre, contenu, dateAjout, dateModif) VALUES(?, ?, ?, NOW(), NOW())');
    ...
    {
        return $this->db->query('SELECT id FROM new')->num_rows;
    }
    ...
    public function delete($id)
    {
        ...
        $requete = $this->db->prepare('DELETE FROM new WHERE id = ?');
    ...
    public function getUnique($id)
    {
        ...
        $requete = $this->db->prepare('SELECT id, auteur, titre, contenu, dateAjout, dateModif FROM new WHERE id = ?');
        $requete->bind_param('i', $id);
        $requete->execute();
    ...
    {
        $requete = $this->db->prepare('UPDATE new SET auteur = ?, titre = ?, contenu = ?, dateModif = NOW() WHERE id = ?');
